    ...
    companion object {
        ...
        fun getCustomColorStateList(context: Context): ColorStateList {
            return ColorStateList(
                ...
                intArrayOf(
                    ContextCompat.getColor(context, R.color.black),//disabled
                    ContextCompat.getColor(context, R.color.green) //enabled
                )
            )
        }
        ...
        fun setSwitchColor(v: SwitchCompat, context: Context) {
            ...
            val thumbColor = ContextCompat.getColor(context, R.color.green)
        ...
        fun isValidTelephoneNumber(telephoneNumber: String): Boolean {
            return telephoneNumber.length >= 8
        }
    }
}